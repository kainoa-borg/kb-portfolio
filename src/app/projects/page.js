            ...
            <Swiper navigation={true} modules={[Navigation, Autoplay]} loop={true} autoplay={{delay: 5000, disableOnInteraction: true}}>
                <SwiperSlide className='relative w-[100%]'>
                    ...
                    <div className='absolute flex flex-col backdrop-blur-xl p-1 items-center justify-center lg:h-[30%] h-[40%] lg:w-1/3 w-[100%] top-[80%] right-[50%] translate-x-[50%] translate-y-[-50%] bg-[#456573]/70'>
                        ...
                        <a className='p-4 mt-1 w-1/3 text-center text-white hover:bg-[#62929E] font-mono' href='https://kainoa-borg.github.io/andrea-site'>Explore</a>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    ...
                    <div className='absolute flex flex-col backdrop-blur-xl p-1 items-center justify-center lg:h-[30%] h-[40%] lg:w-1/3 w-[100%] top-[80%] right-[50%] translate-x-[50%] translate-y-[-50%] bg-[#456573]/70'>
                        ...
                        <a className='p-4 mt-1 w-1/3 text-center text-white hover:bg-[#62929E] font-mono' href='https://github.com/FoodDesertDatabase/FoodForwardTracker/'>View on Github</a>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    ...
                    <div className='absolute flex flex-col backdrop-blur-xl p-1 items-center justify-center lg:h-[30%] h-[40%] lg:w-1/3 w-[100%] top-[80%] right-[50%] translate-x-[50%] translate-y-[-50%] bg-[#456573]/70'>
                        ...
                        <a className='p-4 mt-1 w-1/3 text-center text-white hover:bg-[#62929E] font-mono' href='https://kainoa-borg.github.io/hacker-news-clone'>Explore</a>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    ...
                    <div className='absolute flex flex-col backdrop-blur-xl p-1 items-center justify-center lg:h-[30%] h-[40%] lg:w-1/3 w-[100%] top-[80%] right-[50%] translate-x-[50%] translate-y-[-50%] bg-[#456573]/70'>
                        ...
                        <a className='p-4 mt-1 w-1/3 text-center text-white hover:bg-[#62929E] font-mono' href='https://github.com/kainoa-borg/Simple-Multithreaded-Raytracer'>View on Github</a>
                    </div>
                </SwiperSlide>
            </Swiper>
        </div>
